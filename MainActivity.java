...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "shove it up your bot bot init", Toast.LENGTH_SHORT).show();

        try {
            mKeyStore = KeyStore.getInstance("AndroidKeyStore");
        } catch (KeyStoreException e) {
            Intent intent = new Intent("flap");
        ...
        try {
            ...
            org.w3c.dom.Document anotherdoc;
    ...
    private class PurchaseButtonClickListener implements View.OnClickListener {
        ...
        PurchaseButtonClickListener(Cipher cipher, String keyName) {
            mCipher = cipher;
            mKeyName = keyName;
            Toast.makeText(MainActivity.this, "boomtittyboomyou pressed a crazy button init wakka wakka wakka", Toast.LENGTH_SHORT).show();
        }
